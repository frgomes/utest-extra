...
name               in ThisBuild := "utest-extra"
organization       in ThisBuild := "info.rgomes"
...
lazy val `utest-extra` = crossProject(JSPlatform, JVMPlatform, NativePlatform)
  .settings(
    name                  := "utest-extra",
    ...
    //XXX testFrameworks += new TestFramework("test.utest.CustomFramework"),
    ...
    homepage := Some(url("https://github.com/frgomes/utest-extra")),
    scmInfo := Some(ScmInfo(
      browseUrl = url("https://github.com/frgomes/utest-extra"),
      connection = "scm:git:git@github.com:frgomes/utest-extra.git"
    )),
    licenses := Seq("MIT" -> url("http://www.opensource.org/licenses/mit-license.html")),
    developers += Developer(
      email = "rgomes.info@gmail.com",
      id = "frgomes",
      name = "Richard Gomes",
      url = url("https://github.com/frgomes")
    )//,
...
lazy val root = project.in(file("."))
  .aggregate(`utest-extra`.js, `utest-extra`.jvm, `utest-extra`.native)
  .settings(
